...
static const struct reg_default ak7755_reg_defaults[] = {
	{AK7755_C0_CLOCK_SETTING1,				0x00},	/*	0xC0	AK7755_C0_CLOCK_SETTING1			*/
	{AK7755_C1_CLOCK_SETTING2,				0x00},	/*	0xC1	AK7755_C1_CLOCK_SETTING2			*/
	{AK7755_C2_SERIAL_DATA_FORMAT,			0x00},	/*	0xC2	AK7755_C2_SERIAL_DATA_FORMAT		*/
	{AK7755_C3_DELAY_RAM_DSP_IO,			0x00},	/*	0xC3	AK7755_C3_DELAY_RAM_DSP_IO			*/
	{AK7755_C4_DATARAM_CRAM_SETTING,		0x00},	/*	0xC4	AK7755_C4_DATARAM_CRAM_SETTING		*/
	{AK7755_C5_ACCELARETOR_SETTING,			0x00},	/*	0xC5	AK7755_C5_ACCELARETOR_SETTING		*/
	{AK7755_C6_DAC_DEM_SETTING,				0x00},	/*	0xC6	AK7755_C6_DAC_DEM_SETTING			*/
	{AK7755_C7_DSP_OUT_SETTING,				0x00},	/*	0xC7	AK7755_C7_DSP_OUT_SETTING			*/
	{AK7755_C8_DAC_IN_SETTING,				0x00},	/*	0xC8	AK7755_C8_DAC_IN_SETTING			*/
	{AK7755_C9_ANALOG_IO_SETTING,			0x00},	/*	0xC9	AK7755_C9_ANALOG_IO_SETTING			*/
	{AK7755_CA_CLK_SDOUT_SETTING,			0x00},	/*	0xCA	AK7755_CA_CLK_SDOUT_SETTING			*/
	{AK7755_CB_TEST_SETTING,				0x00},	/*	0xCB	AK7755_CB_TEST_SETTING				*/
	{AK7755_CC_VOLUME_TRANSITION,			0x00},	/*	0xCC	AK7755_CC_VOLUME_TRANSITION			*/
	{AK7755_CD_STO_DLS_SETTING,				0x80},	/*	0xCD	AK7755_CD_STO_DLS_SETTING			*/
	{AK7755_CE_POWER_MANAGEMENT,			0x00},	/*	0xCE	AK7755_CE_POWER_MANAGEMENT			*/
	{AK7755_CF_RESET_POWER_SETTING,			0x00},	/*	0xCF	AK7755_CF_RESET_POWER_SETTING		*/
	{AK7755_D0_FUNCTION_SETTING,			0x00},	/*	0xD0	AK7755_D0_FUNCTION_SETTING			*/
	{AK7755_D1_DSPMCLK_SETTING,				0x00},	/*	0xD1	AK7755_D1_DSPMCLK_SETTING			*/
	{AK7755_D2_MIC_GAIN_SETTING,			0x00},	/*	0xD2	AK7755_D2_MIC_GAIN_SETTING			*/
	{AK7755_D3_LIN_LO3_VOLUME_SETTING,		0x00},	/*	0xD3	AK7755_D3_LIN_LO3_VOLUME_SETTING	*/
	{AK7755_D4_LO1_LO2_VOLUME_SETTING,		0x00},	/*	0xD4	AK7755_D4_LO1_LO2_VOLUME_SETTING	*/
	{AK7755_D5_ADC_DVOLUME_SETTING1,		0x30},	/*	0xD5	AK7755_D5_ADC_DVOLUME_SETTING1		*/
	{AK7755_D6_ADC_DVOLUME_SETTING2,		0x30},	/*	0xD6	AK7755_D6_ADC_DVOLUME_SETTING2		*/
	{AK7755_D7_ADC2_DVOLUME_SETTING1,		0x30},	/*	0xD7	AK7755_D7_ADC2_DVOLUME_SETTING1		*/
	{AK7755_D8_DAC_DVOLUME_SETTING1,		0x18},	/*	0xD8	AK7755_D8_DAC_DVOLUME_SETTING1		*/
	{AK7755_D9_DAC_DVOLUME_SETTING2,		0x18},	/*	0xD9	AK7755_D9_DAC_DVOLUME_SETTING2		*/
	{AK7755_DA_MUTE_ADRC_ZEROCROSS_SET,		0x00},	/*	0xDA	AK7755_DA_MUTE_ADRC_ZEROCROSS_SET	*/
	{AK7755_DB_ADRC_MIC_GAIN_READ,			0x00},	/*	0xDB	AK7755_DB_ADRC_MIC_GAIN_READ		*/
	{AK7755_DC_TEST_SETTING,				0x00},	/*	0xDC	AK7755_DC_TEST_SETTING				*/
	{AK7755_DD_ADC2_DVOLUME_SETTING2,		0x30},	/*	0xDD	AK7755_DD_ADC2_DVOLUME_SETTING2		*/
	{AK7755_DE_DMIC_IF_SETTING,				0x00},	/*	0xDE	AK7755_DE_DMIC_IF_SETTING			*/
};
...
static inline u32 ak7755_read_reg_cache(struct ak7755_priv *, u16);
...
struct snd_ctl_elem_value  *ucontrol)
{
	...
	if ( ak7755->lign <= 7) {
		snd_soc_component_update_bits(component, AK7755_D3_LIN_LO3_VOLUME_SETTING, 0xF0, ((7 - ak7755->lign) << 4) );
	}
	else {
		snd_soc_component_update_bits(component, AK7755_D3_LIN_LO3_VOLUME_SETTING, 0xF0, ((ak7755->lign + 1) << 4) );
	}
...
struct snd_ctl_elem_value  *ucontrol)
{
	...
	if ( ak7755->selmix < 4) {	//SELMIX2=0, SELMIX1-0=selmix
		snd_soc_component_update_bits(component, AK7755_C9_ANALOG_IO_SETTING, 0x01, 0x00);
		snd_soc_component_update_bits(component, AK7755_C8_DAC_IN_SETTING, 0x03, ak7755->selmix);
	}
	else {						//SELMIX2=1, SELMIX1-0=(selmix & 0x03)
		snd_soc_component_update_bits(component, AK7755_C9_ANALOG_IO_SETTING, 0x01, 0x01);
		snd_soc_component_update_bits(component, AK7755_C8_DAC_IN_SETTING, 0x03, (ak7755->selmix & 0x03));
	}
...
static int test_read_ram(int mode)
{
	...
	snd_soc_component_update_bits(ak7755_data->component, AK7755_CF_RESET_POWER_SETTING, 0x1, 0x1);  // DLRDY bit = 1
	mdelay(1);
	if ( mode == 1 ) {
		plen = 10;
	...
	mdelay(1);
	snd_soc_component_update_bits(ak7755_data->component, AK7755_CF_RESET_POWER_SETTING, 0x1, 0x0);  // DLRDY bit = 0
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:	/* after widget power up */
		snd_soc_component_update_bits(component, AK7755_CF_RESET_POWER_SETTING, 0x08,0x08);	//CRESETN(CODEC ResetN)=1
		break;
	}
		...
		struct snd_kcontrol *kcontrol, int event) //CONFIG_LINF
{
	...
	switch (event) {
		...
		case SND_SOC_DAPM_PRE_PMD:	/* before widget power down */
			snd_soc_component_update_bits(component, AK7755_CF_RESET_POWER_SETTING, 0x08,0x00);	//CODEC Reset
			break;
	}
...
static const struct snd_kcontrol_new ak7755_dspinad_control =
	SOC_DAPM_SINGLE_VIRT("DSPINAD Switch", 1);

static const struct snd_kcontrol_new ak7755_dspinad2_control =
	SOC_DAPM_SINGLE_VIRT("DSPINAD2 Switch", 1);
...
static const struct snd_kcontrol_new ak7755_sdoutad_selmix_control =
	SOC_DAPM_SINGLE_VIRT("SELMIX Switch", 1);
...
//	SND_SOC_DAPM_MUX("LineOut Amp1", AK7755_CE_POWER_MANAGEMENT, 2, 0, &ak7755_pmlo1_mux_control),
	...
	SND_SOC_DAPM_SWITCH("LineOut Amp1", SND_SOC_NOPM, 0, 0,	&ak7755_pmlo1_mux_control),
	SND_SOC_DAPM_SWITCH("LineOut Amp2", SND_SOC_NOPM, 0, 0,	&ak7755_pmlo2_mux_control),
...
// Analog Input
	...
	SND_SOC_DAPM_SWITCH("DSPIN SDOUTAD2", SND_SOC_NOPM, 0, 0, &ak7755_dspinad2_control),
	SND_SOC_DAPM_SWITCH("DSPIN SDOUTAD", SND_SOC_NOPM, 0, 0, &ak7755_dspinad_control),
...
// Multiplexer (selects 1 analog signal from many inputs) & Mixer
	...
	SND_SOC_DAPM_SWITCH("SELMIX DSP", SND_SOC_NOPM, 0, 0, &ak7755_dsp_selmix_control),
	SND_SOC_DAPM_SWITCH("SELMIX AD2", SND_SOC_NOPM, 0, 0, &ak7755_sdoutad2_selmix_control),
	SND_SOC_DAPM_SWITCH("SELMIX AD", SND_SOC_NOPM, 0, 0, &ak7755_sdoutad_selmix_control),
...
static int ak7755_hw_params_set(struct snd_soc_component *component, int nfs)
{
	u8 	fs;

	akdbgprt("\t[AK7755] %s(%d)\n",__FUNCTION__,__LINE__);

	fs = snd_soc_component_read(component, AK7755_C0_CLOCK_SETTING1);
	fs &= ~AK7755_FS;
	...
	snd_soc_component_write(component, AK7755_C0_CLOCK_SETTING1, fs);
		...
		struct snd_soc_dai *dai)
{
	...
	ak7755_hw_params_set(component, ak7755_data->fs);
...
static int ak7755_set_dai_fmt(struct snd_soc_dai *dai, unsigned int fmt)
{
	...
	struct snd_soc_component *component = dai->component;
	struct ak7755_priv *ak7755 = snd_soc_component_get_drvdata(component);  // '15/06/15
	u8 mode, mode2;
	u8 format;
	...
	mode = snd_soc_component_read(component, AK7755_C0_CLOCK_SETTING1);		//CKM2-0(M/S)
	mode &= ~AK7755_M_S;
	mode2 = snd_soc_component_read(component, AK7755_CA_CLK_SDOUT_SETTING);	//BICKOE,LRCKOE
	format = snd_soc_component_read(component, AK7755_C2_SERIAL_DATA_FORMAT);
	format &= ~AK7755_LRIF;
	...
	snd_soc_component_update_bits(component, AK7755_C1_CLOCK_SETTING2, 0x30, (ak7755->bickfs << 4));
	if ( ak7755->bickfs < 3 ) {
		format &= 0x7F;
	} else {
		format |= 0x80;
	...
	case SND_SOC_DAIFMT_I2S:
		...
		snd_soc_component_update_bits(component, AK7755_C3_DELAY_RAM_DSP_IO, 0xF0, 0xf0); 	// DIF2, DOF2
		snd_soc_component_update_bits(component, AK7755_C6_DAC_DEM_SETTING, 0x37, 0x33);		//DIF, DIFDA
		snd_soc_component_update_bits(component, AK7755_C7_DSP_OUT_SETTING, 0xFF, 0xf3); 	//DOF
		break;
	case SND_SOC_DAIFMT_LEFT_J:
		...
		if ( ak7755->bickfs == 2 ) {   // 32fs
			...
			snd_soc_component_update_bits(component, AK7755_C3_DELAY_RAM_DSP_IO, 0xF0, 0x0); 	// DIF2, DOF2
			snd_soc_component_update_bits(component, AK7755_C6_DAC_DEM_SETTING, 0x37, 0x0);	//DIF, DIFDA
			snd_soc_component_update_bits(component, AK7755_C7_DSP_OUT_SETTING, 0xFF, 0x0); 	//DOF
		}
		break;
/*
...
*/
	...
	/* set format */
	snd_soc_component_write(component, AK7755_C0_CLOCK_SETTING1, mode);
	snd_soc_component_write(component, AK7755_CA_CLK_SDOUT_SETTING, mode2);
	snd_soc_component_write(component, AK7755_C2_SERIAL_DATA_FORMAT, format);
...
/*
static int ak7755_readable(struct snd_soc_component *component, unsigned int reg)
{
 ...
 */
static inline u32 ak7755_read_reg_cache(struct ak7755_priv *ak7755, u16 reg)
{
    u8 *cache = ak7755->reg_cache;
...
static unsigned int ak7755_reg_read(struct ak7755_priv *component, unsigned int reg)
{
	...
	if (ret < 0) {
		...
		if (ak7755_read_reg_cache(component, reg) != rdata)
			ak7755_write_reg_cache(component, reg, rdata);
	}
...
static int ak7755_reg_write(struct ak7755_priv *component, unsigned int reg, unsigned int value)
{
	unsigned char tx[3];
	int	wlen;
	int ret;
	...
	if (ret >=0) {
		ak7755_write_reg_cache(component, reg, value);
	}
 ...
 */
// ak7755_writeMask() => snd_soc_component_update_bits()  // '16/01/13
...
static int ak7755_set_status(enum ak7755_status status)
{
	...
	switch (status) {
	case RUN:
		snd_soc_component_update_bits(ak7755_data->component, AK7755_C1_CLOCK_SETTING2, 0x1, 0x1);  // CKRESETN bit = 1
		mdelay(10);
		snd_soc_component_update_bits(ak7755_data->component, AK7755_CF_RESET_POWER_SETTING, 0xc, 0xc);  // CRESETN bit = DSPRESETN = 1;
		mdelay(10);
		break;
	case DOWNLOAD:
		snd_soc_component_update_bits(ak7755_data->component, AK7755_CF_RESET_POWER_SETTING, 0x1, 0x1);  // DLRDY bit = 1
	...
	case STANDBY:
		snd_soc_component_update_bits(ak7755_data->component, AK7755_C1_CLOCK_SETTING2, 0x1, 0x1);  // CKRESETN bit = 1
		mdelay(10);
		snd_soc_component_update_bits(ak7755_data->component, AK7755_CF_RESET_POWER_SETTING, 0xc, 0x0);  // CRESETN bit = DSPRESETN = 0;
		mdelay(10);
		break;
	case SUSPEND:
	case POWERDOWN:
		snd_soc_component_update_bits(ak7755_data->component, AK7755_CF_RESET_POWER_SETTING, 0x3f, 0x0);
		snd_soc_component_update_bits(ak7755_data->component, AK7755_CE_POWER_MANAGEMENT, 0xFF, 0x0);
		snd_soc_component_update_bits(ak7755_data->component, AK7755_C1_CLOCK_SETTING2, 0x0, 0x0);
		mdelay(10);
		break;
	default:
		return -EINVAL;
...
static int ak7755_ram_download(const u8 *tx_ram, u64 num, u16 crc)
{
	...
	nDSPRun = snd_soc_component_read(ak7755_data->component, AK7755_CF_RESET_POWER_SETTING);
...
//		ak7755_set_status(STANDBY);
		snd_soc_component_write(ak7755_data->component, AK7755_CF_RESET_POWER_SETTING, nDSPRun);
		return rc;
	}
...
static int ak7755_reg_cmd(REG_CMD *reg_param, int len)
{
	...
	for (i = 0; i < len; i++) {
		...
		if ( addr != 0xFF ) {
			rc = snd_soc_component_write(ak7755_data->component, addr, value);
			if (rc < 0) {
				break;
			}
		}
...
static int ak7755_trigger(struct snd_pcm_substream *substream, int cmd, struct snd_soc_dai *component_dai)
{
...
static int ak7755_set_bias_level(struct snd_soc_component *component,
...
static int ak7755_set_dai_mute2(struct snd_soc_component *component, int mute)
{
	int ret = 0;
	//int ndt;
	...
	if (mute) {	//SMUTE: 1 , MUTE
		ret = snd_soc_component_update_bits(component, AK7755_DA_MUTE_ADRC_ZEROCROSS_SET, 0xE0, 0xE0);
	}
	else {
		ak7755_set_status(RUN);
		// SMUTE: 0 ,NORMAL operation
		ret = snd_soc_component_update_bits(component, AK7755_DA_MUTE_ADRC_ZEROCROSS_SET, 0xE0, 0x00);
	}
...
static int ak7755_set_dai_mute(struct snd_soc_dai *dai, int mute, int stream)
{
    struct snd_soc_component *component = dai->component;

	ak7755_set_dai_mute2(component, mute);
...
static struct snd_soc_dai_ops ak7755_dai_ops = {
	...
	.mute_stream = ak7755_set_dai_mute,
};
...
static int ak7755_init_reg(struct snd_soc_component *component)
{
	struct ak7755_priv *ak7755 = snd_soc_component_get_drvdata(component);   // '15/06/15
	...
	ak7755_set_bias_level(component, SND_SOC_BIAS_STANDBY);

	snd_soc_component_update_bits(component, AK7755_D4_LO1_LO2_VOLUME_SETTING, 0xFF, 0xFF);			//LOVOL1,2=F(0dB)
	snd_soc_component_update_bits(component, AK7755_D3_LIN_LO3_VOLUME_SETTING, 0x0F, 0x0F);			//LOVOL3=F(0dB)
	snd_soc_component_update_bits(component, AK7755_D2_MIC_GAIN_SETTING, 0xFF, 0xCC);
	snd_soc_component_update_bits(component, AK7755_D0_FUNCTION_SETTING, 0x40, 0x40);				//CRCE=1(CRC Enable)
	snd_soc_component_update_bits(component, AK7755_C2_SERIAL_DATA_FORMAT, 0x40, AK7755_BCKP_BIT);	//BCKP bit
	snd_soc_component_update_bits(component, AK7755_D0_FUNCTION_SETTING, 0x10, AK7755_SOCFG_BIT);	//SOFG bit
#ifdef DIGITAL_MIC		//Analog MIC Use
	snd_soc_component_update_bits(component, AK7755_DE_DMIC_IF_SETTING, 0x90, 0x90);					//DMIC1=DMIC2=1(Digital MIC Use)
	snd_soc_component_update_bits(component, AK7755_DE_DMIC_IF_SETTING, 0x40, AK7755_DMCLKP1_BIT);	//DMCLKP1 bit
	snd_soc_component_update_bits(component, AK7755_DE_DMIC_IF_SETTING, 0x08, AK7755_DMCLKP2_BIT);	//DMCLKP2 bit
	snd_soc_component_update_bits(component, AK7755_C0_CLOCK_SETTING1, 0x08, 0x00);
#else
	snd_soc_component_update_bits(component, AK7755_C0_CLOCK_SETTING1, 0x08, 0x08);		//AINE=1(Analog MIC Use)
#endif

#if 0
	snd_soc_component_write(component, 0xC0, 0x2A);
	snd_soc_component_write(component, 0xC1, 0x20);
	snd_soc_component_write(component, 0xC2, 0x10);
	snd_soc_component_write(component, 0xC3, 0xf0);
	snd_soc_component_write(component, 0xC4, 0x00);
	snd_soc_component_write(component, 0xC5, 0x00);
	snd_soc_component_write(component, 0xC6, 0x33);
	snd_soc_component_write(component, 0xC7, 0xf3);
	snd_soc_component_write(component, 0xC8, 0xC0);
	snd_soc_component_write(component, 0xC9, 0x20);
	snd_soc_component_write(component, 0xCA, 0x01);
	snd_soc_component_write(component, 0xCC, 0x03);
	snd_soc_component_write(component, 0xCD, 0xC0);
	snd_soc_component_write(component, 0xCE, 0x45);
	snd_soc_component_write(component, 0xCF, 0x00);
	snd_soc_component_write(component, 0xD0, 0x00);
	snd_soc_component_write(component, 0xD1, 0x00);
	snd_soc_component_write(component, 0xD2, 0x00);
	snd_soc_component_write(component, 0xD3, 0x00);
	snd_soc_component_write(component, 0xD4, 0x0F);
	snd_soc_component_write(component, 0xD5, 0x30);
	snd_soc_component_write(component, 0xD6, 0x30);
	snd_soc_component_write(component, 0xD7, 0x30);
	snd_soc_component_write(component, 0xD8, 0x18);
	snd_soc_component_write(component, 0xD9, 0x18);
	snd_soc_component_write(component, 0xDA, 0x10);
	snd_soc_component_write(component, 0xDB, 0x00);
	snd_soc_component_write(component, 0xDD, 0x30);
	snd_soc_component_write(component, 0xDE, 0x00);
	snd_soc_component_write(component, 0xE6, 0x01);
	snd_soc_component_write(component, 0xEA, 0x80);
	snd_soc_component_write(component, 0xc1, 0x21);
	msleep(10);
	snd_soc_component_write(component, 0xcf, 0x0c);
#endif
	...
	if(aec == 1) {
		...
		snd_soc_component_update_bits(component, AK7755_C8_DAC_IN_SETTING, 0xC0, 0x00);
		/*Lineout1 power on*/
		snd_soc_component_update_bits(component, AK7755_CE_POWER_MANAGEMENT, 0xC7, 0xC7);

		/*Select SDOUT1 MUX as DOUT1 Of DSP*/
		snd_soc_component_update_bits(component, AK7755_CC_VOLUME_TRANSITION, 0x07, 0x00);
	} else {
		/*Select DAC MUX as SDIN1*/
		snd_soc_component_update_bits(component, AK7755_C8_DAC_IN_SETTING, 0xC0, 0xC0);
		/*Lineout1 power on*/
		snd_soc_component_update_bits(component, AK7755_CE_POWER_MANAGEMENT, 0xC7, 0xC7);

		/*Select SDOUT1 MUX as SDOUTAD*/
		snd_soc_component_update_bits(component, AK7755_CC_VOLUME_TRANSITION, 0x07, 0x03);
	}
...
static int ak7755_parse_dt(struct ak7755_priv *ak7755)
{
	...
	ak7755->pdn_active = !!(GPIOF_ACTIVE_LOW);
	...
	ak7755->power_gpio = of_get_named_gpio(np, "ak7755,pwr-gpio", 0);
	ak7755->power_active = !!(GPIOF_ACTIVE_LOW);
	if (ak7755->power_gpio < 0 || !gpio_is_valid(ak7755->power_gpio)) {
		ak7755->power_gpio = -1;
	}

	ak7755->amp_gpio = of_get_named_gpio(np, "ak7755,amp-gpio", 0);
	ak7755->amp_active = !!(GPIOF_ACTIVE_LOW);
...
static int ak7755_probe(struct snd_soc_component *component)
{
	struct ak7755_priv *ak7755 = snd_soc_component_get_drvdata(component);
#ifndef CONFIG_OF
	struct ak7755_platform_data *pdata = component->dev->platform_data;   // '15/06/15
#endif
	...
	if (gpio_is_valid(ak7755->pdn_gpio))
		ret = devm_gpio_request(component->dev, ak7755->pdn_gpio, "ak7755 pdn");

	if (ret < 0){
		dev_err(component->dev, "Failed to request pdn pin for ak7755: %d\n", ret);
		return ret;
	}

	if (gpio_is_valid(ak7755->power_gpio))
		ret = devm_gpio_request(component->dev, ak7755->power_gpio, "ak7755 power");

	if (ret < 0){
		dev_err(component->dev, "Failed to request power pin for ak7755: %d\n", ret);
		return ret;
	}

	if (gpio_is_valid(ak7755->amp_gpio))
		ret = devm_gpio_request(component->dev, ak7755->amp_gpio, "ak7755 amplifier");

	if (ret < 0){
		dev_err(component->dev, "Failed to request amplifier pin for ak7755: %d\n", ret);
		return ret;
	}

	ak7755_set_reg_table();
	ak7755_init_reg(component);
...
static void ak7755_remove(struct snd_soc_component *component)
{
	struct ak7755_priv *ak7755 = snd_soc_component_get_drvdata(component);

	akdbgprt("\t[AK7755] %s(%d)\n",__FUNCTION__,__LINE__);

	ak7755_set_bias_level(component, SND_SOC_BIAS_OFF);
...
static int ak7755_suspend(struct snd_soc_component *component)
{
	struct ak7755_priv *ak7755 = snd_soc_component_get_drvdata(component);
...
static int ak7755_resume(struct snd_soc_component *component)
{
	struct ak7755_priv *ak7755 = snd_soc_component_get_drvdata(component);
	...
	ak7755_set_bias_level(component, SND_SOC_BIAS_ON);
	printk("ak7755_resume done...\n");

	return 0;
}

struct snd_soc_component_driver soc_component_dev_ak7755 = {
...
EXPORT_SYMBOL_GPL(soc_component_dev_ak7755);
...
#ifdef AK7755_I2C_IF
static bool ak7755_readable_register(struct device *dev, unsigned int reg)
{
	switch(reg){
	case AK7755_C0_CLOCK_SETTING1:
	case AK7755_C1_CLOCK_SETTING2:
	case AK7755_C2_SERIAL_DATA_FORMAT:
	case AK7755_C3_DELAY_RAM_DSP_IO:
	case AK7755_C4_DATARAM_CRAM_SETTING:
	case AK7755_C5_ACCELARETOR_SETTING:
	case AK7755_C6_DAC_DEM_SETTING:
	case AK7755_C7_DSP_OUT_SETTING:
	case AK7755_C8_DAC_IN_SETTING:
	case AK7755_C9_ANALOG_IO_SETTING:
	case AK7755_CA_CLK_SDOUT_SETTING:
	case AK7755_CB_TEST_SETTING:
	case AK7755_CC_VOLUME_TRANSITION:
	case AK7755_CD_STO_DLS_SETTING:
	case AK7755_CE_POWER_MANAGEMENT:
	case AK7755_CF_RESET_POWER_SETTING:
	case AK7755_D0_FUNCTION_SETTING:
	case AK7755_D1_DSPMCLK_SETTING:
	case AK7755_D2_MIC_GAIN_SETTING:
	case AK7755_D3_LIN_LO3_VOLUME_SETTING:
	case AK7755_D4_LO1_LO2_VOLUME_SETTING:
	case AK7755_D5_ADC_DVOLUME_SETTING1:
	case AK7755_D6_ADC_DVOLUME_SETTING2:
	case AK7755_D7_ADC2_DVOLUME_SETTING1:
	case AK7755_D8_DAC_DVOLUME_SETTING1:
	case AK7755_D9_DAC_DVOLUME_SETTING2:
	case AK7755_DA_MUTE_ADRC_ZEROCROSS_SET:
	case AK7755_DB_ADRC_MIC_GAIN_READ:
	case AK7755_DC_TEST_SETTING:
	case AK7755_DD_ADC2_DVOLUME_SETTING2:
	case AK7755_DE_DMIC_IF_SETTING:
		return true;
	default:
		break;
	}
	return ak7755_readable_register(dev, reg);
}

static struct regmap_config ak7755_i2c_regmap = {
	.reg_bits = 8,
	.val_bits = 8,
	...
	.readable_reg = ak7755_readable_register,
                            ...
                            const struct i2c_device_id *id)
{
	...
	regmap = devm_regmap_init_i2c(i2c, &ak7755_i2c_regmap);
	if (IS_ERR(regmap)) {
		ret = PTR_ERR(regmap);
		dev_err(&i2c->dev, "regmap_init() for ak7755 failed: %d\n", ret);
		return ret;
	}
	...
	ret = snd_soc_register_component(&i2c->dev,
			&soc_component_dev_ak7755, &ak7755_dai[0], ARRAY_SIZE(ak7755_dai));
	if (ret < 0){
		kfree(ak7755);
...
static const struct regmap_config ak7755_spi_regmap = {
	.reg_bits 	= 8,
	.val_bits 	= 8,
	.volatile_reg	= ak7755_volatile,
};
static int ak7755_spi_probe(struct spi_device *spi)
{
	...
	regmap = devm_regmap_init_spi(spi, &ak7755_spi_regmap);
	if (IS_ERR(regmap)) {
		ret = PTR_ERR(regmap);
		dev_err(&spi->dev, "regmap_init() for ak7755 failed: %d\n", ret);
		return ret;
	}
...
static void ak7755_spi_remove(struct spi_device *spi)
{
